...
export const categories = ["Necklaces", "Earrings", "Bracelets", "Beaded Sets", "Handcrafted Jewelry", "Home Decor"];
...
export const dummyStoreData = {
    ...
    userId: "user_1",
    name: "Bellore Crafts",
    description: "Bellore Crafts celebrates Maasai beadwork, handcrafted jewelry, and cultural heirlooms made with care by skilled artisans.",
    username: "bellorecrafts",
    address: "Maasai Market, Nairobi, Kenya",
    status: "approved",
    isActive: true,
    logo: happy_store,
    email: "hello@bellorecrafts.com",
...
export const productDummyData = [
    {
        ...
        description: "A stunning handcrafted Maasai bead necklace with intricate traditional patterns, perfect for gifting or making a bold cultural statement.",
        mrp: 120,
        price: 89,
    ...
    },
    {
        ...
        description: "Handcrafted Maasai earrings finished with authentic beads and vibrant colors, designed for everyday wear and festive celebration.",
        mrp: 55,
        price: 39,
        images: [product_img2],
        storeId: "seller_1",
    ...
    },
    {
        ...
        description: "A handcrafted Maasai cuff bracelet with bright beadwork, offering a beautiful blend of tradition and modern style.",
        mrp: 70,
        price: 49,
        images: [product_img3],
        storeId: "seller_1",
    ...
    {
        id: "prod_4",
        name: "Maasai Choker Set",
        description: "An elegant beaded choker set inspired by Maasai heritage, perfect for layering with everyday and ceremonial outfits.",
        mrp: 95,
        price: 69,
        images: [product_img4],
        storeId: "seller_1",
    ...
    {
        id: "prod_5",
        name: "Handcrafted Anklet",
        description: "A delightful beaded anklet made with Maasai craftsmanship, adding color and charm to every step.",
        mrp: 45,
        price: 32,
        images: [product_img5],
        storeId: "seller_1",
    ...
    {
        id: "prod_6",
        name: "Leather & Bead Necklace",
        description: "A rich leather necklace accented with Maasai beads for a natural, handcrafted finish that pairs beautifully with both casual and elegant looks.",
        mrp: 85,
        price: 59,
        images: [product_img6],
        storeId: "seller_1",
    ...
    {
        id: "prod_7",
        name: "Earrings & Bracelet Duo",
        description: "A matching set of Maasai beaded earrings and bracelet, thoughtfully crafted to celebrate traditional beauty.",
        mrp: 110,
        price: 79,
        images: [product_img7],
        storeId: "seller_1",
    ...
    {
        id: "prod_8",
        name: "Beaded Home Accent",
        description: "A handwoven Maasai bead home accent designed to bring warm cultural charm into your living space.",
        mrp: 125,
        price: 99,
        images: [product_img8],
        storeId: "seller_1",
    ...
    {
        id: "prod_9",
        name: "Bracelet Stack Collection",
        description: "A curated stack of Maasai-inspired bracelets, perfect for layering and adding vibrant color to your wardrobe.",
        mrp: 65,
        price: 49,
        images: [product_img9],
        storeId: "seller_1",
    ...
    {
        id: "prod_10",
        name: "Beaded Keychain Set",
        description: "A set of handcrafted keychains featuring vibrant Maasai beadwork, ideal as small gifts or cultural keepsakes.",
        mrp: 39,
        price: 29,
    ...
    {
        id: "prod_11",
        name: "Maasai Beaded Waistband",
        description: "A traditional Maasai waist belt with intricate beadwork, crafted to celebrate cultural heritage and style.",
        mrp: 79,
        price: 59,
    ...
    },
    {
        ...
        description: "A beautiful Maasai-inspired wall hanging that adds color and texture to any home or workspace.",
        mrp: 140,
        price: 99,
...
export const ourSpecsData = [
    { title: "Authentic Craftsmanship", description: "Each piece is handcrafted with genuine Maasai beadwork and traditional finishing techniques.", icon: SendIcon, accent: '#05DF72' },
    { title: "Care & Returns", description: "If your order needs attention, our support team is ready to help with exchanges and care guidance.", icon: ClockFadingIcon, accent: '#FF8904' },
    { title: "Artisan Support", description: "We connect you directly with skilled artisans for a trusted and authentic shopping experience.", icon: HeadsetIcon, accent: '#A684FF' }
]
